...
$(function()
{
    ...
    $('img[ectype="flex"]').click(function(){
        ...
        if(status == 'open')
        {
            ...
            $.get(selfurl + "&act=ajax_cate", {id: id}, function(data){
                if(data)
                {
                    ...
                    for(var i = 0; i < res.length; i++)
                    {
						...
						if(res[i].show_index == '0')
                        {
                            show_index = "<img src='templates/style/images/positive_enabled.gif' ectype='inline_edit' fieldname='show_index' fieldid='"+res[i].cate_id+"' fieldvalue='0'/>";
                        }
                        else
                        {
                            show_index = "<img src='templates/style/images/positive_disabled.gif' ectype='inline_edit' fieldname='show_index' fieldid='"+res[i].cate_id+"' fieldvalue='1'/>";
                        }
			...
			"<td class='align_center'>"+show_index+"</td>"+
