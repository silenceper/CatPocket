...
$my_moneylog_row=$this->my_moneylog_mod->getrow("select * from ".DB_PREFIX."my_moneylog where order_id='$id' and caozuo='10' and s_and_z=1");
...
{
$buy_money_row=$this->my_money_mod->getrow("select * from ".DB_PREFIX."my_money where id='$buy_user_id'");
$buy_money=$buy_money_row['money'];//买家的钱

$sell_money_row=$this->my_money_mod->getrow("select * from ".DB_PREFIX."my_money where id='$sell_user_id'");
