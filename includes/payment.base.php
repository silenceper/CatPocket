...
class BasePayment extends Object
{
	...
	function _create_notify_url1($order_id)
    {
        return SITE_URL . "/index.php?app=paynotify&act=notifys&order_id={$order_id}";
    }
	...
	function _create_return_url1($order_id)
    {
        return SITE_URL . "/index.php?app=my_money&act=return_url&order_id={$order_id}";
    }
     ...
     *    @return    string
     */
    function _get_subject($order_info,$subject_info=0)
    {
		if($subject_info==0)
		{
			return 'CatPocket Order:' . $order_info['order_sn'];
		}
		else
		{
