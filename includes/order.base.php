...
class BaseOrder extends Object
{
    ...
    function _get_payments()
    {
        ...
        return $payment_model->get_enabled();
    }
    ...
    function _handle_order_info($goods_info, $post)
    {
        ...
        return array(
            ...
            'status'        =>  $order_status,
            'add_time'      =>  gmtime(),
            'goods_amount'  =>  $goods_info['goods_amount'],
			'order_amount'  =>  $post['final_price'],
			'jifen'  =>  $post['using_jifen'],
            'discount'      =>  isset($goods_info['discount']) ? $goods_info['discount'] : 0,
            'anonymous'     =>  intval($post['anonymous']),
            'postscript'          =>  trim($post['postscript']),
			'integral_state'  =>  $goods_info['integral_state']
        );
    }
