...
class cls_mysql
{
    ...
    function ErrorMsg($message = '', $sql = '')
    {
        if ($message)
        {
            echo "<b>CatPocket info</b>: $message\n\n";
        }
        else
        {
            ...
            //echo '<a href="http://www.maokoudai.com/help/faq.php?type=mysql&amp;dberrno=' . $error_no . '&amp;dberror=' . urlencode($error) . '" target="_blank">'. Lang::get('mysql_error_report') . '</a>';
        }
