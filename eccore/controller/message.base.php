...
class Message extends MessageBase
{
    ...
    function report_link($err, $msg, $file, $line)
    {
        if (strncmp($msg, 'MySQL Error[', 12) == 0)
        {
            ...
            //$url = 'http://www.maokoudai.com/help/faq.php?type=mysql&dberrno=' . $tmp_arr['dberrno'] . '&dberror=' .  urlencode($tmp_arr['dberror']);
			$url='';
    ...
    function display()
    {
        ...
        else
        {
            ...
            $this->_config_seo('title', Lang::get('catpoket_sysmsg') . '-- Powered by CatPocket');
