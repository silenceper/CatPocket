...
class SearchApp extends MallbaseApp
{
    ...
    function index()
    {
        ...
        $goods_list = $goods_mod->get_list(array(
            ...
            'order'      => isset($_GET['order']) && isset($orders[$_GET['order']]) ? $_GET['order'] : ''.'sales desc',
            'limit'      => $page['limit'],
        ));
	 ...
	 function show_jifenzq()
	{
	    ...
	    $this->display('zqjifen.html');
	}
	function storebm()
	{
	   $this->display('storebm.html');
	}
    ...
    function _get_orders()
    {
        return array(
            ...
            'has_integral desc'         => Lang::get('has_integral_desc'),
	...
	function _get_cate()
    {
		...
		else
		{
			...
			{
				$result = $gcategory_mod->get_list_info($val['cate_id'], true);
