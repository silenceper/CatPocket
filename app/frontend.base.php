...
class MemberbaseApp extends MallbaseApp
{
    ...
    function _get_member_menu()
    {
        ...
        /* 我的CatPocket */
        $menu['my_catpoket'] = array(
            'name'  => 'my_catpoket',
            'text'  => Lang::get('my_catpoket'),
            'submenu'   => array(
                'overview'  => array(
        ...
        $menu['shangfutong'] = array(
            ...
            'submenu'   => array(
				...
				'jifenguanli'  => array(
                    'text'  => Lang::get('jifenguanli'),
                    'url'   => 'index.php?app=my_money&act=jifenguanli',
                    'name'  => 'jifenguanli',
                    'icon'  => 'ico15',
                ),
            ),
        ...
        if ($this->visitor->get('manage_store'))
        {
			...
			$menu['im_seller']['submenu']['take_jifen'] = array(
                    'text'  => Lang::get('take_jifen'),
			...
			$menu['im_seller']['submenu']['customer']  = array(
                    'text'  => Lang::get('customer'),
                    'url'   => 'index.php?app=customer',
                    'name'  => 'customer',
                    'icon'  => 'ico13',
            );
			$menu['im_seller']['submenu']['cat_food']  = array(
                    'text'  => Lang::get('cat_food'),
                    'url'   => 'index.php?app=cat_food',
                    'name'  => 'cat_food',
                    'icon'  => 'ico17',
            );
