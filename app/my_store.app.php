    ...
    function index()
    {
        ...
        else
        {
            ...
            $data = array_merge($data, array(
                ...
                'tel'        => $_POST['tel'],
                'im_qq_1'      => $_POST['im_qq_1'],
                'im_qq_2'      => $_POST['im_qq_2'],
                'im_ww_1'      => $_POST['im_ww_1'],
                'im_ww_2'      => $_POST['im_ww_2'],
                'office_time' =>  $_POST['office_time'],
                'festival_time' => $_POST['festival_time'],
				'postage_explain'  =>  $_POST['postage_explain'],
                'domain'     => $subdomain,
            ));
