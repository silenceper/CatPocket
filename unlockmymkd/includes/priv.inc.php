...
(
	...
	'moneys' => array
    (
        'user_money'  => 'user_money|all',//用户资金管理
        'applymoney_manage' => 'applymoney_manage|all',//提现管理
        'chongzhika' => 'chongzhika|all',//充值卡密管理
		'user_integral' => 'user_integral|all',//积分管理
		'catfood_manage' => 'catfood_manage|all',//猫粮管理
		'jfcade_manage' => 'jfcade_manage|all',//礼品卡管理
    ),
    'order' => array
    (
