...
return array(
    ...
    'goods' => array(
        ...
        'children'  => array(
			...
			'show_index' => array(
                'text'  => LANG::get('show_index'),
                'url'   => 'index.php?app=show_index'
            ),
    ...
    'user' => array(
        ...
        'children'  => array(
            ...
            'admin_manage' => array(
			 ...
			 'jubaogl' => array(
                'text'  => Lang::get('jubaogl'),
                'url'   => 'index.php?app=jubaogl',
            ),
	...
	// 财务
    'money' => array(
        'text'      => Lang::get('moneygl'),
        'default'   => 'user_money',
        'children'  => array(
            'user_money' => array(
                'text'  => Lang::get('user_money'),
                'url'   => 'index.php?module=my_money&act=user_money_list',
            ),
            'applymoney_manage' => array(
                'text' => Lang::get('applymoney_manage'),
                 'url'   => 'index.php?module=my_money&act=tx_index_shenhe',
             ),
             'chongzhika' => array(
                'text' => Lang::get('chongzhika'),
                'url'  => 'index.php?module=my_money&act=card_yichongzhi',
             ),
			 // modify by tyioocom 增加用户积分
			 'user_integral'=> array(
			    'text' => Lang::get('integral_manage'),
				'url'  => 'index.php?app=integral',
			 ),	
			 'catfood_manage' => array(
                'text' => Lang::get('catfood_manage'),
                'url'  => 'index.php?app=catfood',
             ),
			 'jfcade_manage'=> array(
			    'text' => Lang::get('jfcade_manage'),
				'url'  => 'index.php?app=jfcade',
			 ),	
			 'ss_jifen_manage' => array(
                'text'  => Lang::get('ss_jifen_manage'),
                'url'   => 'index.php?app=ss_jifen'
            ),
        ),
    ),
    // 网站
