...
class TemplateApp extends BackendApp
{
    ...
    {
        /* 获取挂件列表 */
		$this->log_result('进来了1');
        $widgets = list_widget();
		$this->log_result('进来了2');
