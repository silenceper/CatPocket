...
class GcategoryApp extends BackendApp
{
    ...
    function ajax_col()
    {
       ...
       $data   = array();
       if (in_array($column ,array('cate_name', 'if_show', 'show_index','sort_order')))
       {
           $data[$column] = $value;
           if($column == 'cate_name')
           {
    ...
    function batch_edit()
    {
        ...
        else
        {
            ...
            $ids = explode(',', $id);
            if ($_POST['if_show'] >= 0 && $_POST['show_index']>=0)
            {
                $data = array('if_show' => $_POST['if_show'] ? 1 : 0,'show_index' => $_POST['show_index'] ? 1 : 0);
