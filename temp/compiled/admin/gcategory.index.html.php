...
<div id="rightTop">
    ...
    <div style="margin-top:15px;color:red;margin-left:10px;">* 首页只显示主分类下的四个，请不要多设置 *</div>
</div>
...
?>
        <tr>
            ...
            <td class="align_center"><?php if ($this->_var['gcategory']['show_index'] == 0): ?><img src="templates/style/images/positive_enabled.gif" ectype="inline_edit" fieldname="show_index" fieldid="<?php echo $this->_var['gcategory']['cate_id']; ?>" fieldvalue="0" title="可编辑"/><?php else: ?><img src="templates/style/images/positive_disabled.gif" ectype="inline_edit" fieldname="show_index" fieldid="<?php echo $this->_var['gcategory']['cate_id']; ?>" fieldvalue="1" title="可编辑"/><?php endif; ?></td>
