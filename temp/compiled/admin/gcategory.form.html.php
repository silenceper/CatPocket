...
<div class="info">
    <form method="post" enctype="multipart/form-data" id="gcategory_form">
        <table class="infoTable">
			...
			<tr>
               <th class="paddingT15">是否需要审核:</th>
                <td class="paddingT15 wordSpacing5"><p>
                <label>
                  <input type="radio" name="is_checked" value="1" <?php if ($this->_var['gcategory']['is_checked'] == '1'): ?>checked="checked"<?php endif; ?> />
                  是</label>
                <label>
                  <input type="radio" name="is_checked" value="0" <?php if ($this->_var['gcategory']['is_checked'] == '0'): ?>checked="checked"<?php endif; ?> />
                  否</label> <label class="field_notice">是否在首页显示</label>
              </p></td>
            </tr>
          <tr>
