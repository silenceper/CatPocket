    ...
    <div class="fontl">
        <form method="get">
            <div class="left">
			  ...
			  <input name="ztai" type="hidden" id="ztai" value="1" />
              充值卡号:
...
?>
        <tr class="tatr2">
            ...
            <td><a href="javascript:drop_confirm('确定删除吗？', 'index.php?module=my_money&act=card_del&id=<?php echo $this->_var['val']['id']; ?>');">删除</a></td>
        </tr>
        <?php endforeach; else: ?>
        <tr class="no_data">
