...
?><?php echo htmlspecialchars($this->_var['cate']['cate_name']); ?>&nbsp;<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?></td>
      ...
      <tr>
        ...
        <td class="paddingT15 wordSpacing5"><?php echo $this->_var['store']['taobao_url']; ?></td>
      </tr>
      <tr>
        <th class="paddingT15">拍拍店铺链接:</th>
        <td class="paddingT15 wordSpacing5"><?php echo $this->_var['store']['paipai_url']; ?></td>
      </tr>
      <tr>
        <th class="paddingT15">其它店铺链接:</th>
        <td class="paddingT15 wordSpacing5"><?php echo $this->_var['store']['other_url']; ?></td>
      </tr>
      <tr>
      ...
      <tr>
          ...
          <option value="0">请选择...</option>
            <?php echo $this->html_options(array('options'=>$this->_var['taobao_rank'])); ?>
          </select>
          </td>
      </tr>
      <tr>
          ...
          <option value="0">请选择...</option>
            <?php echo $this->html_options(array('options'=>$this->_var['paipai_rank'])); ?>
          </select>
          </td>
      </tr>
      <tr>
