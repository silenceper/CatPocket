...
<div class="info">
  <form method="post" enctype="multipart/form-data" id="store_form">
    <table class="infoTable">
      ...
      <tr>
      	<th class="paddingT15"> 淘宝店铺链接:</th>
        <td class="paddingT15 wordSpacing5"><input name="taobao_url" type="text" class="text width7" id="taobao_url" value="<?php echo htmlspecialchars($this->_var['store']['taobao_url']); ?>"/></td>
      </tr>
      <tr>
         <th class="paddingT15"> 拍拍店铺链接:</th>
         <td class="paddingT15 wordSpacing5"><input name="paipai_url" type="text" class="text width7" id="paipai_url" value="<?php echo htmlspecialchars($this->_var['store']['paipai_url']); ?>"/></td>
      </tr>
      <tr>
         <th class="paddingT15"> 其它店铺链接:</th>
         <td class="paddingT15 wordSpacing5"><input name="other_url" type="text" class="text width7" id="other_url" value="<?php echo htmlspecialchars($this->_var['store']['other_url']); ?>"/></td>
      </tr>
      <tr>
          <th class="paddingT15">淘宝店铺等级:</th>
          <td class="paddingT15 wordSpacing5">
          <select class="querySelect" name="taobao_rank">
          <option value="0">请选择...</option>
            <?php echo $this->html_options(array('options'=>$this->_var['taobao_rank'],'selected'=>$this->_var['store']['taobao_rank'])); ?>
          </select>
          </td>
      </tr>
      <tr>
          <th class="paddingT15">拍拍店铺等级:</th>
          <td class="paddingT15 wordSpacing5">
          <select class="querySelect" name="paipai_rank">
          <option value="0">请选择...</option>
            <?php echo $this->html_options(array('options'=>$this->_var['paipai_rank'],'selected'=>$this->_var['store']['paipai_rank'])); ?>
          </select>
          </td>
      </tr>
      <tr>
