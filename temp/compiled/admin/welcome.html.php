...
$(function(){
    ...
    $.getJSON('http://www.maokoudai.com/system/notice2.php?charset=<?php echo $this->_var['cur_lang']; ?>&jsoncallback=?',function(data){
        var message='';
...
<div id="rightTop">
<p>
    您好，<b><?php echo $this->_var['admin']['user_name']; ?></b>，欢迎使用 CatPocket。
...
<dd>
    <table>
        ...
        <tr>
            <th>CatPocket 版本:</th>
            <td class="td"><?php echo $this->_var['sys_info']['catpoket_version']; ?></td>
            <th>安装日期:</th>
