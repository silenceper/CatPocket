                ...
                <div class="wrap_child">
                    <div class="leftkf">
                        ...
                        <ul>
                            ...
                            <a href="http://wpa.qq.com/msgrd?V=1&amp;Uin=<?php echo htmlspecialchars($this->_var['store']['im_qq']); ?>&amp;Site=<?php echo htmlspecialchars($this->_var['store']['store_name']); ?>&amp;Menu=yes" target="_blank"><img src="http://wpa.qq.com/pa?p=1:<?php echo htmlspecialchars($this->_var['store']['im_qq']); ?>:4"></a>
                            <?php endif; ?>
                            </span> 售前</li>
                            <li><span class="ww-light ww-small">
                            <?php if ($this->_var['store']['im_ww_1']): ?>
                    		<a href="http://amos.im.alisoft.com/msg.aw?v=2&uid=<?php echo urlencode($this->_var['store']['im_ww']); ?>&site=cntaobao&s=2&charset=<?php echo $this->_var['charset']; ?>" target="_blank" ><img border="0" src="http://amos.im.alisoft.com/online.aw?v=2&uid=<?php echo urlencode($this->_var['store']['im_ww']); ?>&site=cntaobao&s=2&charset=<?php echo $this->_var['charset']; ?>"/></a>
                   			<?php endif; ?>
                            </span> 售前</li>
                        </ul>
...
?>
        ...
        <div class="module_common">
            <h2 class="common_title veins1">
                <div class="ornament1"></div>
                <div class="ornament2"></div>
                <span class="ico1"><span class="ico2" style="float:left;">浏览历史</span><a onclick="clear_history()" style="float:right;color:rgb(255, 255, 255);font-size:12px;padding-right: 8px; margin-right: 5px;cursor:pointer;color:#F90">清空</a></span>
            </h2>
            <div class="wrap">
                <div class="wrap_child">
...
?>
                        <li>
                            ...
                            <span style="float:left;">
                                <?php echo htmlspecialchars($this->_var['gh_goods']['goods_name']); ?>
                            </span>
                        </li>
                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                    </ul>
