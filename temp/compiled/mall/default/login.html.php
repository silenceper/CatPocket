...
$(function(){
	...
	var banner;
	if (ad==1){ 
		banner="<?php echo $this->res_base . "/" . 'images/login_left1.gif'; ?>"; 
	} 
	if (ad==2){ 
		banner="<?php echo $this->res_base . "/" . 'images/login_left2.gif'; ?> "; 
	}  
	if (ad==3){ 
		banner="<?php echo $this->res_base . "/" . 'images/login_left3.gif'; ?>"; 
	} 
	if (ad==4){ 
		banner="<?php echo $this->res_base . "/" . 'images/login_left4.gif'; ?>"; 
	} 
	if (ad==5){ 
		banner="<?php echo $this->res_base . "/" . 'images/login_left5.gif'; ?>"; 
	} 
	$("#l_left").css('background-image','url('+banner+')');
});
</script>
    ...
    <div class="module_common">
        ...
        <div class="wrap">
            <div class="wrap_child">
                <div class="login_con">
                    <div class="login_left" id="l_left">
