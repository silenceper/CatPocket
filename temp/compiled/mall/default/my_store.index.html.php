            ...
            <form method="post" enctype="multipart/form-data" id="my_store_form">
                    <div class="setup">
                        <div class="photo relative1">
                            ...
                            <span class="explain">此处为您的店铺标志，将显示在店铺信息栏里建议尺寸100*100像素，图片大小建议不超过20k，图片格式限制为gif/png/jpg/jpeg</span>
                        </div>
                    ...
                    <div class="setup info shop">
                        ...
                        <table style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="td_block"><input id="store_name" type="text" class="text width_normal" name="store_name" value="<?php echo htmlspecialchars($this->_var['store']['store_name']); ?>"/><label class="field_notice">店铺名称（请控制在20个字以内）</label></p>
                            ...
                            <tr>
                                  <th>售前QQ:</th>
                                  <td><input name="im_qq_1" type="text" class="text width_normal" id="im_qq_1" value="<?php echo htmlspecialchars($this->_var['store']['im_qq_1']); ?>" /></td>
                            </tr>
                            <tr>
                                  <th>售后QQ:</th>
                                  <td><input name="im_qq_2" type="text" class="text width_normal" id="im_qq_2" value="<?php echo htmlspecialchars($this->_var['store']['im_qq_2']); ?>" /></td>
                            </tr>
                            <tr>
                                  <th>售前阿里旺旺:</th>
                                  <td><input name="im_ww_1" type="text" class="text width_normal" id="im_ww_1" value="<?php echo htmlspecialchars($this->_var['store']['im_ww_1']); ?>" /></td>
                            </tr>
                            <tr>
                                  <th>售后阿里旺旺:</th>
                                  <td><input name="im_ww_2" type="text" class="text width_normal" id="im_ww_2" value="<?php echo htmlspecialchars($this->_var['store']['im_ww_2']); ?>" /></td>
                            </tr>
                            <tr>
                                  <th>工作日时间:</th>
                                  <td><input name="office_time" type="text" class="text width_normal" id="office_time" value="<?php echo htmlspecialchars($this->_var['store']['office_time']); ?>" /><span class="field_notice">显示店铺工作日时间（例：早09:00-晚23:00）</span></td>
                            </tr>
                            <tr>
                                  <th>节假日时间:</th>
                                  <td><input name="festival_time" type="text" class="text width_normal" id="festival_time" value="<?php echo htmlspecialchars($this->_var['store']['festival_time']); ?>" /><span class="field_notice">显示店铺节假日时间（例：早09:00-晚23:00）</span></td>
                            </tr>
                            <tr>
                                  <th>MSN在线通:</th>
                             ...
                             <tr>
                                  <th>邮费说明:</th>
                                  <td><textarea name="postage_explain" id="postage_explain" style="width:400px; height:100px;"><?php echo htmlspecialchars($this->_var['store']['postage_explain']); ?></textarea></td>
                             </tr>
                             <tr>
