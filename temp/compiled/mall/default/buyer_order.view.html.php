                    ...
                    <div class="ware_list">
                        ...
                        <div class="ware_text">
                            ...
                            <div class="ware_text2">
                                ...
                                <span>原价&nbsp;:&nbsp;<strong><?php echo price_format($this->_var['goods']['price']); ?></strong></span>
                                <span>优惠价&nbsp;:&nbsp;<strong style="color:rgb(255, 79, 1); font-size:14px;"><?php echo price_format($this->_var['goods']['bargin_price']); ?></strong></span>
                            </div>
                        </div>
                    </div>
