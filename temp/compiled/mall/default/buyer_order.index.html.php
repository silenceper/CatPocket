...
?>
                    <div class="con">
                        ...
                        <p class="price" style="padding-top:8px;">
                        	<span style="width:200px;color:rgb(145, 145, 145);">原价: <span style="color:rgb(145, 145, 145);"><?php echo price_format($this->_var['goods']['price']); ?></span></span><br/>
                        	<span style="width:200px;color:rgb(255, 79, 1); font-size:13px;">促销价: <span style="color:rgb(255, 79, 1);"><?php echo price_format($this->_var['goods']['bargin_price']); ?></span></span>
                        </p>
