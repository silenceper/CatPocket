...
<div class="content">
    ...
    <div id="right">
        ...
        <div class="wrap">
            <div class="eject_btn_two eject_pos1" ><b class="ico4"><a uri="index.php?app=my_partner&amp;act=add" ectype="dialog" dialog_id="my_partner_add" dialog_width="460" dialog_title="新增友情链接">新增友情链接</a></b></div>
...
?>
                    ...
                    <?php endforeach; else: ?>
                    <tr>
                        <td colspan="6" class="member_no_records padding6">没有符合条件的友情链接</td>
                    </tr>
