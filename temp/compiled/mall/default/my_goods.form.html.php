...
$(function(){
	 function check_url()
	 {
		 var a = ($('#taobao_url').val()==""&&$('#paipai_url').val()=="");
		 return a;
	 };
     $('#goods_form').validate({
        ...
        messages : {
            goods_name  : {
                required   : '商品名称不能为空',
				maxlength  :  '商品名称字数不能超过30个汉字'
            },
			taobao_url  : {
                required   : '商品在淘宝中的链接地址'
            },
			paipai_url  : {
                required   : '商品在拍拍中的链接地址'
            },
            price       : {
                number     : '此项仅能为数字',
                required : '价格不能为空',
...
?>
                                ...
                                <p class="new_add">
                                    <a href="javascript:;" id="add_sgcategory" class="btn">商品子类</a>
                                    <span>可以从属于多个本店分类（如没有店铺分类，请先设置<a href="index.php?app=my_category" style="color:red" target="_blank">店铺分类</a>）</span>
                                </p>
                            </div>
                        </div>
...
?>
                            ...
                            <div class="products">
                                <ul>
                                    <li>
                                        <h2>商品名称: </h2>
                                        <div class="arrange"><input title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" type="text" name="goods_name" value="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" class="text width_normal" /><span class="red field_notice">*</span><label class="error"></label></div>
                                    </li>
                                    <li>
                                        <h2>&nbsp;</h2>
                                        <label style="color:rgb(185, 185, 185); font-size:12px;">商品名称字数不能超过30个汉字</label>
                                    </li>
                                    <li>
                                        <h2>淘宝链接: </h2>
                                        <div class="arrange"><input title="<?php echo htmlspecialchars($this->_var['goods']['taobao_url']); ?>" type="text" name="taobao_url" id="taobao_url" value="<?php echo htmlspecialchars($this->_var['goods']['taobao_url']); ?>" class="text width_normal" /><span class="red field_notice">*</span></div>
                                    </li>
                                    <li>
                                        <h2>&nbsp;</h2>
                                        <label style="color:rgb(185, 185, 185); font-size:12px;">请输入商品在淘宝中的链接地址（淘宝、拍拍任选一个）</label>
                                    </li>
                                    <li>
                                        <h2>拍拍链接: </h2>
                                        <div class="arrange"><input title="<?php echo htmlspecialchars($this->_var['goods']['paipai_url']); ?>" type="text" name="paipai_url" id="paipai_url" value="<?php echo htmlspecialchars($this->_var['goods']['paipai_url']); ?>" class="text width_normal" /><span class="red field_notice">*</span></div>
                                    </li>
                                    <li>
                                        <h2>&nbsp;</h2>
                                        <label style="color:rgb(185, 185, 185); font-size:12px;">请输入商品在拍拍中的链接地址（淘宝、拍拍任选一个）</label>
                                    </li>
                                    <li>
                                        <h2>品牌: </h2>
                                    ...
                                    <li>
                                        <h2>&nbsp;</h2>
                                        <label style="color:rgb(185, 185, 185); font-size:12px; width:300px;"><span style="color:red;">注意：此处价格不得高于您在其他商城上所发布的售价（违者处罚）</span></label>
                                    </li>
                                    <li ectype="no_spec">
                                        <h2>库存: </h2>
                                    ...
                                    <?php if ($this->_var['integral_open']): ?>
                                    <li>
                                        <h2>状态: </h2>
                                        <div class="arrange">
                                            <span class="distance" id="integral_state" style="word-spacing:5px;">
                                                <label><input name="state" onclick="show_div(this)" value="1" <?php if ($this->_var['goods']['integral_state']): ?>checked="checked" <?php endif; ?>type="radio" name="state" /> 积分加钱购物</label>
                                                <label><input name="state" onclick="show_div(this)" value="0" <?php if (! $this->_var['goods']['integral_state']): ?>checked="checked" <?php endif; ?>type="radio" name="state" /> 积分抵扣现金</label>
                                            </span>
                                            <span class="gray">请选择买家使用积分的方式</span>
                                        </div>
                                    </li>
                                    <li>
                                        <ul style="float:left;width:100%;">
                                            <li style="width:180px;">
                                               <h2>促销价:</h2>
                                               <div class="arrange" style="width:120px;"><input name="bargin_price" value="<?php echo $this->_var['goods']['bargin_price']; ?>" type="text" class="text width_short" /></div>
                                            </li>
                                            <li ectype="max_exchange" id="exchange_1"  style="width:200px;<?php if (! $this->_var['goods']['integral_state']): ?>display:none;<?php endif; ?>">
                                                <div>
                                                   <h2>积分数:</h2>
                                                   <div class="arrange" style="width:120px;"><input name="max_exchange" value="<?php echo $this->_var['goods']['max_exchange']; ?>" type="text" class="text width_short" /></div>
                                                </div>
                                            </li>
                                        </ul>
                                        <span class="gray" style="float:left; padding-left:60px;"><strong>积分加钱购物</strong>（用户必须使用您所设置积分加现金才能购买本商品）。</span>
                                        <span class="gray" style="float:left; padding-left:60px;"><strong>积分抵扣现金</strong>（用户可以使用积分抵扣现金购买本商品）。</span>
                                    </li>
                                    <li ectype="has_integral">
                                       <h2>赠送积分:</h2>
                                       <div class="arrange"><input name="has_integral" value="<?php echo $this->_var['goods']['percent']; ?>" type="text" class="text width_short" />%</div>
                                    </li>
                                    <li ectype="has_integral">
                                       <h2>&nbsp;</h2>
                                       <div class="arrange"><span class="gray">买家购买该商品后可获得的积分。此处填写的是<span style="color:#eac;">促销价的百分比</span>，即您允许用户用积分最多能抵扣此商品百分之几的促销价。<span style="color:red;">最低为5%</span>，<span style="color:red;">最高为60%</span>。设置后，卖家的这部分积分将被冻结，该积分将从您的账号中扣除，请慎重填写。</span></div>
                                    </li>
                                    <?php endif; ?>
                                    ...
                                    <li>
                                        ...
                                        <div class="arrange">
                                            <span class="distance">
                                                <label><input name="mianyou" value="1" <?php if ($this->_var['goods']['mianyou']): ?>checked="checked" <?php endif; ?>type="radio" name="c2" /> 是</label>
                                                <label><input name="mianyou" value="0" <?php if (! $this->_var['goods']['mianyou']): ?>checked="checked" <?php endif; ?>type="radio" name="c2" /> 否</label>
                                            </span>
                                        </div>
                                   </li>
                                </ul>
                        ...
                        <div class="add_bewrite">
                            ...
                            <div class="add_wrap">
                                <div class="editor">
                                    ...
                                    <div style=" position: relative; top: 10px; z-index: 5;display:none;"><a class="btn3" id="open_editor_uploader">上传图片</a>
