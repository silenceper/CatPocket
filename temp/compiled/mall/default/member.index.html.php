...
?>
                                ...
                                &nbsp;元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;提现冻结金额：<span style="color:blue;" title="提现"><?php echo $this->_var['val']['money_dj']; ?></span>&nbsp;元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;积分：<span style="color:blue;"><?php echo $this->_var['val']['jifen']; ?></span></span>
                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                </td>
                      		</tr>
                            <?php if ($this->_var['has_store']): ?>
                      		<tr>
                      			<td>
                    				<span>累计已收入：<span style="color:#FF6600;font-size:14px;font-weight:bold;"><?php echo price_format($this->_var['count_all']); ?></span></span> <span style="padding-left:10px;">本月预期收入：<span style="color:#FF6600;font-size:12px;font-weight:bold;"><?php echo price_format($this->_var['pre_count']); ?></span></span>	<span style="padding-left:10px;">本月已收入：<span style="color:#FF6600;font-size:12px;font-weight:bold;"><?php echo price_format($this->_var['current_count']); ?></span></span>

                      			</td>
							</tr>
                            <?php endif; ?>
                        </table>
                        <p><?php echo sprintf('您有 <span class="red">%s</span> 条短消息，<a href="index.php?app=message&act=newpm">点击查看</a>', $this->_var['new_message']); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                        <a href="index.php?app=my_money&act=jifenguanli">领取积分</a>
                        <?php if ($this->_var['has_store']): ?>
                        <a href="index.php?app=my_money&act=jifenguanli#head_c" style="margin-left:20px;">发布礼品卡赚提成</a>
                        <?php endif; ?>
                        </p>
                    </div>
                </div>
