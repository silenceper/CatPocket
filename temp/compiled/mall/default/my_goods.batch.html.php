        ...
        <form id="batch_form" method="POST" enctype="multipart/form-data">
          <div class="information_index">
            <div class="add_wrap">
              ...
              <div class="assort">
                <p class="txt">integral_exchange_value: </p>
                <p class="select">
                  <select name="integral_change"><?php echo $this->html_options(array('options'=>$this->_var['lang']['change_array'])); ?></select>
                  <input name="max_exchange" type="text" class="text" />
                </p>
                <p class="new_add"><span>max_exchange_input_note</span></p>
              </div>
              <?php endif; ?>
