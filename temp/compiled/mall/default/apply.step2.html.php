                ...
                <div class="module_new_shop">
                    ...
                    <div class="info_shop">
                        ...
                        <table>
                            ...
                            <tr>
                                  <th>淘宝店铺链接:</th>
                                  <td><input name="taobao_url" type="text" class="text width7" id="taobao_url" /></td>
                                  <td><span class="field_notice">请输入您在淘宝中店铺的链接地址</span></td>
                            </tr>
                            <tr>
                                  <th>拍拍店铺链接:</th>
                                  <td><input name="paipai_url" type="text" class="text width7" id="paipai_url" /></td>
                                  <td><span class="field_notice">请输入您在拍拍中店铺的链接地址</span></td>
                            </tr>
                            <tr>
                                  <th>其它店铺链接:</th>
                                  <td><input name="other_url" type="text" class="text width7" id="other_url" /></td>
                                  <td><span class="field_notice">请输入您其它网站店铺的链接地址</span></td>
                            </tr>
