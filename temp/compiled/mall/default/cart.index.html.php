...
?>
                        <tr id="cart_item_<?php echo $this->_var['goods']['rec_id']; ?>">
                            <td class="padding1">
                                ...
                                <h3 style="padding:23px 0 0 10px;">
                                    <a href="<?php echo url('app=goods&id=' . $this->_var['goods']['goods_id']. ''); ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>"><?php echo htmlspecialchars($this->_var['goods']['goods_name_1']); ?></a>
                                    <span class="attr"><?php echo htmlspecialchars($this->_var['goods']['specification']); ?></span>
                                </h3>
                            </td>
                            <td class="align1">
                            	<span class="price1" style="color:rgb(254, 78, 19);">&nbsp;<?php echo htmlspecialchars($this->_var['goods']['max_exchange']); ?>&nbsp;</span>
                            </td>
                            <td class="align1">
                            	<p class="price1" style="text-decoration:line-through;">&nbsp;<?php echo price_format($this->_var['goods']['price']); ?>&nbsp;</p>
                                <p class="price2" style="font-size:18px;"><?php echo price_format($this->_var['goods']['bargin_price']); ?></p>
                            </td>
                            <td class="align2">
                            ...
                            <td class="align1">
                            	<p class="price1" style="text-decoration:line-through;" id="item<?php echo $this->_var['goods']['rec_id']; ?>_subtotal">&nbsp;<?php echo price_format($this->_var['goods']['subtotal']); ?>&nbsp;</p>
                                <p class="price2" style="font-size:18px;" id="item<?php echo $this->_var['goods']['rec_id']; ?>_subtotal_cx"><?php echo price_format($this->_var['goods']['subtotal_cx']); ?></p>
                            </td>
                            <td class="align2">
